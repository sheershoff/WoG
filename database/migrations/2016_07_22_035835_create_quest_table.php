...
class CreateQuestTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('Quest', function (Blueprint $table) {
            ...
            $table->boolean('isHide')->default(0)->comment('старт');
            ...
            $table->boolean('isHide')->default(0)->comment('');
            $table->integer('robotId')->unsigned()->default(0)->comment('Робот которому принадлежит квест');
