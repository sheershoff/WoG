    ...
    public function run()
    {
        ...
        \DB::connection('pgsql')->table('skill_levels')->insert(array (
            ...
            array (
                ...
                'description' => 'Знания в данном направлении позволяют решать комплексные, не тривиальные задачи и выполнять обычные быстрее нормативного срока в 2,5 раза быстрее и более. RoadMap и обучение - тоже ко мне.',
                'organization_id' => 0,
                'created_at' => NULL,
                'updated_at' => NULL,
                'deleted_at' => NULL,
            ...
            array (
                ...
                'code' => '4',
                'name' => 'Хорошие знания',
                'description' => 'Знания в данном направлении позволяют решать не тривиальные задачи и выполнять обычные быстрее нормативного срока в 1,5-2 раза.',
                'organization_id' => 0,
                'created_at' => NULL,
                'updated_at' => NULL,
                'deleted_at' => NULL,
            ...
            array (
                ...
                'description' => 'Знания достаточные, чтоб выполнять задачи требующие данного навыка в нормативные сроки.',
                'organization_id' => 0,
                'created_at' => NULL,
                'updated_at' => NULL,
                'deleted_at' => NULL,
