...
N=App\\Models
PRE_=
php artisan krlove:generate:model RoleUser --table-name=$PRE_role_user --output-path=$P --namespace=$N
exit
pause
php artisan krlove:generate:model User --table-name=$PRE_users --base-class-name=BaseModelWithSoftDeletes
